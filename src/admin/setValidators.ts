...
export async function set_validators(addresses: string[], weights: []):Promise<Transaction|undefined>
{
	...
	txb.moveCall({
		target: conf[CONF_ENV].STSUI_LATEST_PACKAGE_ID+"::liquid_staking::set_validator_addresses_and_weights",
